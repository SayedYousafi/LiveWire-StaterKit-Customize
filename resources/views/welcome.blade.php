        ...
        @endif
            ...
            <td colspan="3">
              <div class="container">
                <fieldset class="scheduler-border">
                  <legend class="scheduler-border"> Dimentions / Others</legend>
                  <table class="table">
                    <tr>
                      <th>Weight</th>
                      <th>Length</th>
                    ...
                    <tr>
                      <td><input type="text" class="form-control form-control-sm" wire:model="weight"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="length"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="width"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="height"></td>

                      <td><input type="text" class="form-control form-control-sm" wire:model="is_qty_dividable"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="isbn"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="many_components"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="effort_rating"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="is_pu_item"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="is_meter_item"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="foq"></td>
                      <td>
                        <select wire:model="is_new" class="form-control form-control-sm">
                          <option value=""> --- </option>
                    ...
                    <tr>
                      <th>Taric:</th>
                      <td colspan="14">
                        <select wire:model="taric_id">
                          @foreach ($tarics as $taric)
                          <option value="{{ $taric->id }}">{{ $taric->id }} - {{ $taric->code }} - {{ $taric->name_en }}
                          </option>
                          @endforeach
                    ...
                    <tr>
                      <td colspan="14" align="right"><button wire:click='editDimentions({{ $itemDetail->item_id}})'
                          class="btn btn-dark btn-sm"> Save</button> </td>
                    </tr>
                  </table>
                </fieldset>
              </div>
          ...
          <tr>
            <td colspan="3">
              <div class="container">
                <fieldset class="scheduler-border">
                  <legend class="scheduler-border">Warehouse Item </legend>
                  <table class="table">
                    <tr>
                      <th>ID DE</th>
                      <th>NO DE</th>
                    ...
                    <tr>
                      <td><input type="text" class="form-control form-control-sm" wire:model="ItemID_DE" disabled></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="item_no_de"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="item_name_de"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="item_name_en"></td>
                      <td><input type="text" style="width:75px;" class="form-control form-control-sm"
                          wire:model="is_stock_item"></td>
                      <td><input type="text" style="width:75px;" class="form-control form-control-sm"
                          wire:model="stock_qty" disabled></td>
                      <td><input type="text" style="width:75px;" class="form-control form-control-sm"
                          wire:model="is_active"></td>
                      <td><input type="text" style="width:75px;" class="form-control form-control-sm" wire:model="msq">
                      </td>
                      <td><input type="text" style="width:75px;" class="form-control form-control-sm"
                          wire:model="is_no_auto_order"></td>
                      <td><input type="text" style="width:75px;" class="form-control form-control-sm"
                          wire:model="buffer"></td>
                      <td>
                        <select wire:model="is_SnSI" class="form-control form-control-sm">
                          <option value="Y">Yes</option>
                          <option value="N">No</option>
                        </select>
                      </td>
                    ...
                    <tr>
                      <td colspan="11" align="right"><button wire:click='editWareHouse({{ $itemDetail->ean}})'
                          class="btn btn-dark btn-sm" onclick="scrollMe()"> Save</button></td>
                    </tr>
                  </table>
                </fieldset>
              </div>
          ...
          <tr>
            <td colspan="3">
              <div class="container">
                <fieldset class="scheduler-border">
                  <legend class="scheduler-border">Default Supplier</legend>
                  <table class="table">
                    <tr>
                      <th>Supplier</th>
                      <th>Province</th>
                    ...
                    <tr>
                      <td><input type="text" class="form-control form-control-sm" wire:model="name"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="province"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="full_address"></td>
                      <td><input type="text" class="form-control form-control-sm" wire:model="contact_person"></td>
                    </tr>
                    <tr>
                      <td colspan="4" align="right"><button class="btn btn-dark btn-sm"
                          wire:click='editSupplier({{ $itemDetail->supplier_id }})' onclick="scrollMe()"> Save</button>
                      </td>
                    </tr>
                  </table>
                </fieldset>
          ...
          <td colspan="3">
            <div class="container">
              <fieldset class="scheduler-border">
                <legend class="scheduler-border">Supplier Item</legend>
                <table class="table">
                  <tr>
                    <th>PriceRMB</th>
                    <th>isPO</th>
                  ...
                  <tr>
                    <td><input type="text" style="width:75px; background:#F5F5F5" class="form-control form-control-sm"
                        wire:model="price_rmb"></td>
                    <td>
                      <select wire:model="is_po">
                        <option value="Yes">Yes</option>
                        <option value="No">No</option>
                      </select>
                    <td><textarea class="form-control form-control-sm" wire:model="url"> </textarea></td>
                    <td><input style="width:75px;" type="text" class="form-control form-control-sm" wire:model="moq">
                    </td>
                    <td><input style="width:75px;" type="text" class="form-control form-control-sm" wire:model="oi">
                    </td>
                    <td><input style="width:75px;" type="text" class="form-control form-control-sm"
                        wire:model="lead_time"></td>
                    <td><textarea class="form-control form-control-sm" wire:model="note_cn"> </textarea></td>
                  </tr>
                  <tr>
                    <td colspan="9" align="right"><button class="btn btn-dark btn-sm"
                        wire:click='editSuppItem({{ $itemDetail->supp_id }})' onclick="scrollMe()">Save</button> </td>
                  </tr>
                </table>
              </fieldset>
            </div>
          ...
          <tr>
            <td colspan="3">
              <div class="container">
                <fieldset class="scheduler-border">
                  <legend class="scheduler-border">Picture Item</legend>
                  <table class="table">
                    <tr>
                      <td colspan="3" align="center"> <img src="{{ asset('storage/'.$itemDetail->photo) }}"
                    ...
                    <tr>
                      ...
                      <th><strong>Child apply</strong> </th>
                      <th><strong>Parent apply</strong></th>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <table border="1" class="table">
                          <tr>
                            <td nowrap="nowrap" nowarp>Apply same pictures for these Var Values:</td>
                            <th>Check</th>
                          <tr>
                            <td><input type="text" class="form-control form-control-sm" wire:model="value_de" disabled>
                            </td>
                            <td align="center"><input type="radio" wire:model.live='var_values' value="{{ $value_de }}">
                            </td>
                          </tr>
                          <tr>
                            <td>
                              @if($itemDetail->value_de_2=='')
                              <input type="text" class="form-control form-control-sm" wire:model="value_de_2"
                                style="display: none">
                              @else
                              <input type="text" class="form-control form-control-sm" wire:model="value_de_2" disabled>
                            </td>

                            <td align="center"><input type="radio" wire:model.live='var_values'
                                value="{{ $value_de_2 }}"></td>
                            @endif
                          </tr>
                          <tr>
                            <td>
                              ...
                              <input type="text" class="form-control form-control-sm" wire:model="value_de_3"
                                style="display: none">
                              @else
                              <input type="text" class="form-control form-control-sm" wire:model="value_de_3" disabled>
                            <td align="center"><input type="radio" wire:model.live='var_values'
                                value="{{ $value_de_3 }}"></td>
                            @endif
                    ...
                    <tr>
                      <td colspan="2">Values selected: <span>{{ $var_values }}</span> </td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <button class="btn btn-dark btn-sm float-end"
                          wire:click="getValues('{{ $itemDetail->par_id }}')" onclick="scrollMe()">Apply</button>
                      </td>
                    </tr>
                  </table>
            ...
            <div class="d-flex">
              <td> Apply this picture to this parent of all child<br>
                <input type="text" value="{{ $itemDetail->parent_no_de }}" disabled> id: {{ $itemDetail->par_id }}<br>
                <button class="btn btn-dark btn-sm float-end"
                  wire:click="applyPicParent({{$itemDetail->par_id }})">Apply</button>
              </td>
            </div>
          </tr>
        ...
        <tr>
          ...
          <td colspan="3">
            <table class="table">
              <tr>
                <th>isNpr</th>
                <th><strong>New picture require remarks</strong></th>
                <th><strong>Edit shop picture path</strong></th>
                <th><strong>Edit eBay picture path</strong></th>
              </tr>
              <tr>
                <td>
                  <select wire:model="is_npr" class="form-control form-control-sm" disabled>
                    <option value="Y">Yes</option>
                    <option value="N">No</option>
                  </select>
                ...
                <td>
                  <div class="d-flex">
                    <textarea wire:model="npr_remark" cols="50" rows="1" class="form-control form-control-sm"
                      style="width:350px;" required> </textarea>
                    <button wire:click='setNprRemark({{$itemDetail->item_id}})' class="btn btn-dark btn-sm"
                      onclick="scrollMe()">Remark</button>
                  </div>
                </td>
                <td><input wire:model='pix_path' class="form-control form-control-sm"></td>
                <td><input wire:model='pix_path_eBay' class="form-control form-control-sm"></td>
              </tr>
              <tr>
                <td colspan="5" align="right"><button class="btn btn-dark btn-sm"
                    wire:click='editPixPath({{ $itemDetail->supp_id }})' onclick="scrollMe()">Save</button></td>
              </tr>
            </table>
          </td>
        </tr>
