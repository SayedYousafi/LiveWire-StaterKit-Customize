<div class="p-6 bg-white dark:bg-gray-900 rounded shadow">
    ...
    <div class="text-center text-lg font-bold mb-4">
        ...
        <flux:button class="ml-4 px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700" onclick="history.back()">
            Back</flux:button>
    </div>
    ...
    <div class="flex justify-between gap-6">
        ...
        <fieldset class="border border-gray-300 dark:border-gray-600 p-4 mt-6 rounded">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                ...
                <div class="col-span-2">
                    <flux:input wire:model="value_de" placeholder="Enter value" disabled />
                    @if($itemDetail->value_de_2 != '')
                    <flux:input wire:model="value_de_2" placeholder="Enter value" disabled />
                    @endif
                    @if($itemDetail->value_de_3 != '')
                    <flux:input wire:model="value_de_3" placeholder="Enter value" disabled />
                    @endif
                </div>
            </div>
            <div class="text-right mt-4">
        ...
        <fieldset class="border border-gray-300 dark:border-gray-600 p-4 mt-6 rounded">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                ...
                <div class="col-span-2">
                    <flux:input wire:model="value_en" placeholder="Enter value" />
                    <flux:input wire:model="value_en_2" placeholder="Enter value"
                        :disabled="$itemDetail->value_de_2 == ''"
                        class="{{ $itemDetail->value_de_2 == '' ? 'hidden' : '' }}" />

                    <flux:input wire:model="value_en_3" placeholder="Enter value"
                        :disabled="$itemDetail->value_de_3 == ''"
                        class="{{ $itemDetail->value_de_3 == '' ? 'hidden' : '' }}" />
    ...
    <fieldset class="border border-gray-300 dark:border-gray-600 p-4 mt-6 rounded">
        ...
        <flux:callout variant="success" heading="{{ $successMessage }}" class="mb-3" />
        @endif
        <legend class="text-lg font-semibold px-2 bg-white dark:bg-gray-900 text-black dark:text-white">Warehouse Item
        </legend>
    ...
    <fieldset class="border border-gray-300 dark:border-gray-600 p-4 mt-6 rounded">
        ...
        <flux:callout variant="success" heading="{{ $successMessage }}" class="mb-3" />
        @endif
        <legend class="text-lg font-semibold px-2 bg-white dark:bg-gray-900 text-black dark:text-white">Default Supplier
        </legend>
    ...
    @endif
        ...
        <flux:callout variant="success" heading="{{ $successMessage }}" class="mb-3" />
        @endif
        <legend class="text-lg font-semibold px-2 bg-white dark:bg-gray-900 text-black dark:text-white">Pictures paths &
            NPR
        </legend>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
            <div>
