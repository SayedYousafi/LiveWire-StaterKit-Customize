<div class="container card" x-data="{ rows: @entangle('rows').defer }">
    <div class="card-header text-center">
        ...
        <div class="flex justify-between">
            <flux:button size='sm' onclick="history.back()" class=" bg-blue-600! text-white! hove:bg-blue-500!"
                icon='arrow-uturn-left'>Back
            </flux:button>
            <flux:heading size='lg'>Short Description Template items of {{ $pItems->de_no }}, {{ $pItems->name_en }}
            </flux:heading>
            <flux:button size="sm" wire:click="exportCsv" icon='arrow-top-right-on-square' variant="danger">Export to
                CSV</flux:button>
        </div>
    </div>
    <div class="card-body">
                ...
                <tr>
                    <td class="w-25 p-3">
                        <select wire:model.live="rows.{{ $index }}.type" class="h-10"
                            ...
                            <option value="3">STP by ItemNameDE</option>
                            <option value="6">STP by Model</option>
                            <option value="4">PDF</option>
                            <option value="5">PDFred</option>
                        </select>
                    </td>
                    <td>
        ...
        <table class="table-default mt-4">
            ...
            2 => "<p>{$item->value} <strong><a
                        href='mailto:info@gtech.de?subject=Inquiry {$item->parent_name_en}'>{$item->parent_name_en}
                        Inquiry</a></strong></p>",
            3 => "<p><a href='https://data.gtech-shop.de/CAD/" . str_replace(' ', '_', $item->parent_name) .
                    ".stp'><img src='https://data.gtech-shop.de/data/Icons/STP_Icon.jpg' /> <strong>Download                     {$item->value}
                        &quot;{$item->parent_name}.stp&quot;</strong></a></p>",
            4 => "<p><a href='https://data.gtech-shop.de/Datasheets/" . str_replace(' ', '_', $item->parent_name) .
                    ...
                    <strong>Download  {$item->parent_name}.pdf</strong></a></p>",
            ...
            6 => "<p><a href='https://data.gtech-shop.de/CAD/{$item->model}.stp'><img alt=''
                        ...
                        &quot;{$item->model}.stp&quot;</strong></a> <a href='mailto:info@gtech.de?subject=Inquiry {$item->parent_name_en}'>
            ...
            2 => "<p>{$item->value2} <strong><a
                        href='mailto:info@gtech.de?subject=Anfrage {$item->parent_name}'>{$item->parent_name}
                        Anfrage</a></strong></p>",
            3 => "<p><a href='https://data.gtech-shop.de/CAD/" . str_replace(' ', '_', $item->parent_name) . ".stp'><img
            ...
            6 => "<p><a href='https://data.gtech-shop.de/CAD/{$item->model}.stp'><img alt=''
                        src='https://data.gtech-shop.de/data/Icons/STP_Icon.jpg' /> <strong>Download
                        &quot;{$item->model}.stp&quot;</strong></a> <a href='mailto:info@gtech.de?subject=Anfrage {$item->parent_name}'>
            ...
            <tr>
                ...
                <td valign='middle'>
                    <a href="{{ route('itemEdit', $item_id) }}" target="_blank"
                        class="!text-blue-600 hover:!underline">{{ $ean }}</a>
                </td>
