    ...
    <table class="table-default mt-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $customer->company_subname }}</td>
                <td>{{ $customer->delivery_subname }}</td>
                {{-- <td>{{ $customer->delivery_company_name }}</td> --}}
                <td>{{ $customer->delivery_country }}, {{ $customer->delivery_city }}, {{
                    $customer->delivery_postal_code }}, {{ $customer->delivery_address_line1 }} {{
                    $customer->delivery_address_line2 }}</td>
