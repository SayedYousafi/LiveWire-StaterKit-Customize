...
<img src="{{ storage_path('app/public/pictures/001.jpeg') }}" alt="Image"> --}}
  ...
  <div class="content">
    ...
    <table>
      ...
      <tr>
        ...
        <td rowspan="5" valign="top">
          <table border="0" align="center">
            ...
            <tr>
              <td>{{ $item->delivery_company_name }} <br> {{$item->delivery_contact_person }}</td>
            </tr>
            <tr>
      ...
      <tr>
        <td>{{ $item->customer_company_name }} <br> {{ $item->contact_first_name }} {{ $item->contact_name }}</td>
    ...
    <table style="width: 100%; margin: 15">
      <tbody>
        ...
        <tr>
          ...
          <td></td>
          <td colspan="5">
            We hereby confirm that no raw material from Russia were used <br> in the production of the goods mentioned
            in this invoice.
          </td>
        </tr>
      </tbody>
