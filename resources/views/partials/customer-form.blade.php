...
<form wire:submit.prevent="save" class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-2">
        ...
        <div class="md:col-span-4 flex justify-between items-center pt-4">
            <flux:button icon='plus-circle' type="submit" variant="primary" size="sm">Save</flux:button>
            <flux:button icon='x-mark' id="close" type="button" size="sm" wire:click='cancel'
